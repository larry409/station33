        ...
        <div className="carousel-container max-w-5xl mx-auto">
          ...
          <div className="flex items-center justify-between mt-12">
            ...
            <div className="flex gap-4">
              <button
                onClick={goToPrev}
                className="w-14 h-14 rounded-full border-2 border-primary-text text-primary-text hover:bg-primary-text hover:text-bg-dark transition-all duration-300 flex items-center justify-center font-bold text-xl"
